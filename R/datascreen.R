...
#' by Tabachnick and Fidell to analyze the data for outliers 
...
#' 
#' @param eq The full equation with all x, m, and cvs created from the `createformula()` function.
#' @param df The dataframe where the columns from the formula can be found. Note that only the columns used in the analysis will be screened.
#' @param with_out A logical value where you want to keep the outliers in the data screening `TRUE` or exclude them from the data screening `FALSE`.
